...
* [(2014) Ray tracing with OpenGL Compute Shaders](https://github.com/LWJGL/lwjgl3-wiki/wiki/2.6.1.-Ray-tracing-with-OpenGL-Compute-Shaders-%28Part-I%29) ⭐ 433 | 🐛 1 | 📅 2023-08-30 by **Kai Burjack** - Detailed tutorial series about ray tracing using OpenGL (LWJGL).
...
* [tracy](https://github.com/wolfpld/tracy) ⭐ 16,575 | 🐛 211 | 🌐 C++ | 📅 2026-08-10 - A real time remote telemetry frame profiler for games and other applications.
* [RenderDoc](https://github.com/baldurk/renderdoc) ⭐ 10,969 | 🐛 51 | 🌐 C++ | 📅 2026-08-11 - RenderDoc is a stand-alone graphics debugging tool.
...
* [GLSLbin](http://glslb.in) - Fragment shader sandbox supporting [glslify](https://github.com/stackgl/glslify) ⭐ 2,283 | 🐛 63 | 🌐 JavaScript | 📅 2022-06-29.
...
* [assimp](https://github.com/assimp/assimp) ⭐ 13,131 | 🐛 525 | 🌐 C++ | 📅 2026-08-12 - Portable library to import 3D models in a uniform manner.
* [Magnum](https://github.com/mosra/magnum) ⭐ 5,186 | 🐛 77 | 🌐 C++ | 📅 2026-08-06 - It is a 2D/3D graphics engine for modern OpenGL.
* [Pangolin](https://github.com/stevenlovegrove/Pangolin) ⭐ 2,735 | 🐛 48 | 🌐 C++ | 📅 2026-05-14 - Lightweight portable rapid development library for managing OpenGL display / interaction and abstracting video input.
...
* [glad](https://github.com/Dav1dde/glad) ⭐ 4,574 | 🐛 32 | 🌐 C | 📅 2026-06-18 - Multi profile loader-generator based on the official specs.
...
* [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,814 | 🐛 18 | 🌐 C++ | 📅 2023-06-25 by **David Lettier**
* [OpenGL Examples](https://github.com/McNopper/OpenGL) ⭐ 2,597 | 🐛 0 | 🌐 C | 📅 2026-08-01 by **Norbert Nopper**
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,062 | 🐛 100 | 📅 2026-06-30 - A curated list of awesome lists.
...
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,117 | 🐛 12 | 🌐 Markdown | 📅 2026-08-10 - A awesome list about game development.
...
Please see [CONTRIBUTING](https://github.com/eug/awesome-opengl/blob/master/CONTRIBUTING.md) ⭐ 2,431 | 🐛 0 | 📅 2026-01-09 for details.
