...
* [tracy](https://github.com/wolfpld/tracy) ⭐ 16,643 | 🐛 166 | 🌐 C++ | 📅 2026-08-22 - A real time remote telemetry frame profiler for games and other applications.
* [RenderDoc](https://github.com/baldurk/renderdoc) ⭐ 11,003 | 🐛 49 | 🌐 C++ | 📅 2026-08-20 - RenderDoc is a stand-alone graphics debugging tool.
...
* [GLIntercept](https://github.com/dtrebilco/glintercept) ⭐ 553 | 🐛 5 | 🌐 C++ | 📅 2022-12-02 - OpenGL function call interceptor for Windows.
...
* [GLSLbin](http://glslb.in) - Fragment shader sandbox supporting [glslify](https://github.com/stackgl/glslify) ⭐ 2,285 | 🐛 63 | 🌐 JavaScript | 📅 2022-06-29.
...
* [raylib](https://github.com/raysan5/raylib) ⭐ 34,426 | 🐛 26 | 🌐 C | 📅 2026-08-21 - A simple and easy-to-use library to enjoy videogames programming.
* [assimp](https://github.com/assimp/assimp) ⭐ 13,150 | 🐛 539 | 🌐 C++ | 📅 2026-08-21 - Portable library to import 3D models in a uniform manner.
* [Magnum](https://github.com/mosra/magnum) ⭐ 5,193 | 🐛 76 | 🌐 C++ | 📅 2026-08-18 - It is a 2D/3D graphics engine for modern OpenGL.
* [Pangolin](https://github.com/stevenlovegrove/Pangolin) ⭐ 2,739 | 🐛 48 | 🌐 C++ | 📅 2026-08-19 - Lightweight portable rapid development library for managing OpenGL display / interaction and abstracting video input.
...
* [glad](https://github.com/Dav1dde/glad) ⭐ 4,588 | 🐛 32 | 🌐 C | 📅 2026-06-18 - Multi profile loader-generator based on the official specs.
...
* [3D Game Shaders For Beginners](https://github.com/lettier/3d-game-shaders-for-beginners) ⭐ 19,846 | 🐛 18 | 🌐 C++ | 📅 2023-06-25 by **David Lettier**
* [OpenGL Examples](https://github.com/McNopper/OpenGL) ⭐ 2,601 | 🐛 0 | 🌐 C | 📅 2026-08-01 by **Norbert Nopper**
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 498,848 | 🐛 105 | 📅 2026-08-21 - A curated list of awesome lists.
...
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,176 | 🐛 14 | 🌐 Markdown | 📅 2026-08-17 - A awesome list about game development.
* [awesome-vulkan](https://github.com/vinjn/awesome-vulkan) ⭐ 3,713 | 🐛 5 | 📅 2026-05-11 - A curated list of awesome Vulkan projects and ecosystem.
...
Please see [CONTRIBUTING](https://github.com/eug/awesome-opengl/blob/master/CONTRIBUTING.md) ⭐ 2,436 | 🐛 0 | 📅 2026-01-09 for details.
